...
4. Which features from Azure Search should you take advantage of?
5. How can bot logging be used to benefit Contoso?
6. What are some tasks you'll have to complete to create an efficient and functional calling bot?
